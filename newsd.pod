...
=item B<newsd> -mailgateway  [-preserve-date] I<group>
...
Use only with -mailgateway, this option causes newsd to honor the Date:
field of the incoming message, instead of rewriting it with the current date.
